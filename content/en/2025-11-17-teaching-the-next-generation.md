...
Most programming courses were designed for a world where typing was learning.
We gave students exercises like *“write a function that sorts a list”* or *“implement Fibonacci recursively.”*
They practiced syntax, built small programs, made small mistakes... and learned through friction.

Now that friction is gone.
With ChatGPT, Copilot, or Clever AI, any student can produce a perfect answer in seconds.
If grading depends on the final output, everyone can pass... and no one truly learns.
...
* “Write a loop” → “Trace this loop and explain its behavior.”
* “Implement a function” → “Compare the AI’s implementation with yours — which one is safer, clearer, faster?”
* “Build this app” → “Design its architecture and justify your choices.”
...
Constraint-based learning (limited context, partial prompts, or time-bound challenges) forces students to think.
Ask them to debug broken AI code.
Make them critique different model answers.
Give them incomplete requirements and see how they explore.
...
Pair programming with an AI model becomes an explicit exercise:

1. Prompt design — describe intent precisely.
2. Verification — test and analyze what the model produced.
3. Reflection — document what was learned and what went wrong.

Instead of banning the tool, we make it visible.
The question is no longer *“Did you use AI?”* but *“How did you use it?”*

That transparency turns AI from a shortcut into a teacher.
...
Ideas for new forms of assessment:

* Require a short “lab note” describing how AI was used.
* Ask students to critique or improve an AI’s output.
* Use oral defenses and pair reviews instead of static submissions.
* Evaluate test coverage and design decisions rather than raw syntax.
...
That means experimenting, sharing open lesson plans, and accepting that “teaching AI-era programming” is itself a new discipline.

The best teachers I know aren’t fighting AI.
They’re *teaching with it*, showing students how to question, verify, and think beyond the output.
